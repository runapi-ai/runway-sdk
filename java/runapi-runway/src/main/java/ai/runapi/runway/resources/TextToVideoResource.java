package ai.runapi.runway.resources;
...
public final class TextToVideoResource extends RunwayResource {
  /** API endpoint path for text to video operations. */
  public static final String ENDPOINT = "/api/v1/runway/text_to_video";
