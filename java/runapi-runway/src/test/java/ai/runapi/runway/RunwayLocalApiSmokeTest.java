...
import ai.runapi.runway.types.TextToVideoResponse;
    ...
    class RunwayLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/runway/text_to_video", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (RunwayClient client =
            RunwayClient.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToVideoResponse response =
        ...
        assertEquals("/api/v1/runway/text_to_video", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/runway/text_to_video/task_local_123", captured.path);
